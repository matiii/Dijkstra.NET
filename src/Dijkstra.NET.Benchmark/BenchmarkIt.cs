...
namespace Dijkstra.NET.Benchmark
{
    ...
    public class BenchmarkIt
    {
        ...
        private readonly DijkstraBenchmarkBase _dijkstraOld;
        private readonly DijkstraBenchmarkBase _bfs;

        public BenchmarkIt()
        {
            _dijkstra = new DijkstraBenchmark();
            _dijkstraOld = new DijkstraOldBenchmark();
        ...
        [Benchmark]
        public int DijkstraOldBenchmark()
        {
            var result = _dijkstraOld.GetPath();
