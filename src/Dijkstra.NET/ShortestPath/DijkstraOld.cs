...
{
    public class DijkstraOld<T, TEdgeCustom>: Dijkstra<T, TEdgeCustom> where TEdgeCustom : IEquatable<TEdgeCustom>
    {
        public DijkstraOld(IGraph<T, TEdgeCustom> graph) : base(graph)
        {
        }
